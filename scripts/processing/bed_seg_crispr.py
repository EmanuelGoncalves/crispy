...
def intersect_bed(sample, fc):
    ...
    # Input/Output files
    file_snp_bed = '{}/{}.snp6.picnic.bed'.format(mp.SNP_PICNIC_BED, sample)
    file_crispr_bed = 'data/crispr_bed/{}.crispr.bed'.format(sample)
    file_bed = 'data/crispr_bed/{}.crispr.snp.bed'.format(sample)
