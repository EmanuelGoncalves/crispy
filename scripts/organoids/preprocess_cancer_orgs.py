...
if __name__ == '__main__':
    ...
    for gset in [essential, nessential]:
        ...
        cy.QCplot.plot_cumsum_auc(gene_fc, gset, palette=pal)

        plt.gcf().set_size_inches(3, 3)
        plt.savefig(f'reports/organoids/cancer_orgs_qc_aucs_{gset.name}.png', bbox_inches='tight', dpi=600)
        plt.close('all')
