...
if __name__ == '__main__':
    ...
    for lib_name, lib_ss_df in lib_ss.groupby("library"):
        ...
        # Counts
        #
        counts_df = pd.read_excel(f"{DPATH}/{lib_name}_samples_counts.xlsx", index_col=0)
        ...
        plt.savefig(f"{RPATH}/{lib_name}_lorenz_curve.pdf", bbox_inches="tight", dpi=600)
        plt.close("all")
        ...
        plt.savefig(f"{RPATH}/{lib_name}_counts_boxplots.pdf", bbox_inches="tight", dpi=600)
        plt.close("all")
